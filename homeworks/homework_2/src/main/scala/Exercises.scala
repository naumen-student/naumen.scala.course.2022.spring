object Exercises {
    ...
    def sumByFunc(leftVec0: Vector2D, leftVec1: Vector2D, someFunction: (Vector2D, Vector2D) => Double, rightVec0: Vector2D, rightVec1: Vector2D): Double = {someFunction(leftVec0, leftVec1)+someFunction(rightVec0,rightVec1)}
