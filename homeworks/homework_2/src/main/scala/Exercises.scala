object Exercises {
  ...
  */
  ...
  def sortByHeavyweight(ballsArray: Map[String, (Int, Double)] = balls): Seq[String] =
    ballsArray.map(kv => (kv._1, 4/3 * java.lang.Math.PI * kv._2._1 * kv._2._2)).toSeq.sortBy(_._2).map(_._1)
  ...
  /*Реализовать юнит-тесты в src/test/scala для данной функции.*/
  def primeFactor(number: Int, list: List[Int] = List.empty[Int]): Seq[Int] = {
