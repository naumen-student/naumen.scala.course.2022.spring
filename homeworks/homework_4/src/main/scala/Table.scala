...
{
  private var Cells: mutable.Seq[Cell] = mutable.Seq.fill(width*height)(new EmptyCell)
  ...
  private def isInRange(ix: Int, iy: Int): Boolean = (0 until width contains ix) && (0 until height contains iy)
}