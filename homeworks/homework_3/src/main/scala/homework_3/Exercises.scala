...
object Exercises {
    ...
    class MyIntegers1[Int](integers: List[Int]) extends Iterable[Int] {
      override def iterator: Iterator[Int] = integers.iterator
    }

    class MyIntegers2[Int](integers: Int*) extends Iterable[Int] {
      override def iterator: Iterator[Int] = integers.iterator
    }

    def sum1(x: Int, y: Int): Int = sumIntegers(Seq(x,y))
    def sum2(x: Int, y: Int): Int = sumIntegers(new MyIntegers1(List(x,y)))
    def sum3(x: Int, y: Int): Int = sumIntegers(new MyIntegers2(x,y))
