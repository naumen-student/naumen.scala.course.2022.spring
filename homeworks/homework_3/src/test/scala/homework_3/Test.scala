...
object Test extends TestSuite{
    ...
    val tests = Tests{
        ...
        'test_prettyBooleanFormatter1 - {
            assert(Exercises.prettyBooleanFormarter1(true) == trueStr)
            assert(Exercises.prettyBooleanFormarter1(false) == falseStr)
            assert(Exercises.prettyBooleanFormarter1(1) == "1")
            assert(Exercises.prettyBooleanFormarter1("1") == "1")
        }
        'test_prettyBooleanFormatter2 - {
            assert(Exercises.prettyBooleanFormarter2(true) == trueStr)
            assert(Exercises.prettyBooleanFormarter2(false) == falseStr)
            assert(Exercises.prettyBooleanFormarter2(1) == "1")
            assert(Exercises.prettyBooleanFormarter2("1") == "1")
        }

        'test_prettyBooleanFormatter3 - {
            assert(Exercises.prettyBooleanFormarter3(true) == trueStr)
            assert(Exercises.prettyBooleanFormarter3(false) == falseStr)
            assert(Exercises.prettyBooleanFormarter3(1) == "1")
            assert(Exercises.prettyBooleanFormarter3("1") == "1")
        }
